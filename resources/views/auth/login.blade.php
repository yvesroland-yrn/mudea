...
.logo-img-wrap svg { color: #fff; }
.logo-text h3 {
    font-size: 1rem; font-weight: 800; color: var(--green); line-height: 1.1;
}
.logo-text p {
...
.options a:hover { color: var(--gold-light); }
...
/* Pied de formulaire */
.form-footer {
    text-align: center; font-size: .78rem; color: var(--muted); margin-top: 4px;
}
.form-footer a { color: var(--green); font-weight: 700; text-decoration: none; }
...
.deco-circle.c1 { width: 200px; height: 200px; top: -60px; right: -60px; }
.deco-circle.c2 { width: 120px; height: 120px; top: 30px;  right: 30px;  border-color: rgba(245,197,24,.25); }
.deco-circle.c3 { width: 80px;  height: 80px;  top: 70px;  right: 70px; }
...
.image-content h2 span { color: var(--gold-light); }
...
.feat-icon svg { color: var(--gold-light); }
...
.stat-item span { font-size: .7rem; color: rgba(255,255,255,.65); }
...
@media (max-width: 900px) {
    ...
    .image-content { padding: 32px 32px 36px; }
    .image-content h2 { font-size: 1.7rem; }
    .stats-row { display: none; }
}

@media (max-width: 600px) {
    body { padding: 14px; }
    .login-form { padding: 32px 24px 36px; }
    .form-heading h1 { font-size: 2rem; }
    .options { flex-direction: column; align-items: flex-start; }
    .image-content { padding: 24px 24px 28px; }
    .image-content h2 { font-size: 1.45rem; }
    .image-content p { font-size: .82rem; }
...
<div class="login-card">
    ...
    <div class="login-form">
        ...
        <div class="logo-box">
            <div class="logo-img-wrap">
                ...
                <svg style="display:none" width="28" height="28" fill="none" stroke="currentColor" stroke-width="2.2" viewBox="0 0 24 24">
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            @if(session('status'))
                <div style="background:#e8f5e9;border:1px solid #a5d6a7;color:#2e7d32;padding:10px 14px;border-radius:8px;font-size:.8rem;margin-bottom:14px;font-weight:600;">
                    {{ session('status') }}
                </div>
            @endif
    ...
    <div class="login-image">
        ...
        <div class="image-content">
            ...
            <p>Gérez vos informations, consultez les actualités et accédez facilement aux services de la Mutuelle de Développement d'Andé.</p>
