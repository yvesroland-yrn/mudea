...
@section('page-subtitle','Gérer le contenu Education')
    ...
    <div class="modal-header">
      <div class="modal-header-left">
        ...
        <div>
          ...
          <div class="modal-subtitle">Education — Nouveau contenu</div>
        </div>
      </div>
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <input id="f-titre" type="text" name="titre" class="form-control"
                 placeholder="Ex : Cours de mathématiques niveau 6ème…" required>
        </div>
        ...
        <div class="form-group">
          ...
          <textarea id="f-description" name="description" class="form-control"
                    placeholder="Résumé ou description du contenu éducatif…" required></textarea>
        </div>
