...
@section('page-subtitle', 'Créer une nouvelle actualité')
...
@section('content')
    ...
    <div class="form-container">
        <div class="form-header">
            ...
            <div class="form-header-title">Créer une nouvelle actualité</div>
        </div>
                        ...
                        <div class="form-row full">
                            <div class="field">
                                ...
                                <div style="display:flex;justify-content:flex-end;">
                                    <span class="char-count" id="m-tc">{{ strlen(old('titre')) }}/120</span>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="field">
                                ...
                                <select id="categorie" name="categorie" required>
                                    ...
                                    <option value="projets" {{ old('categorie') == 'projets' ? 'selected' : '' }}>Projets
                                    </option>
                                    <option value="education" {{ old('categorie') == 'education' ? 'selected' : '' }}>
                                        Éducation</option>
                                    <option value="communaute" {{ old('categorie') == 'communaute' ? 'selected' : '' }}>
                                        Communauté</option>
                                    <option value="culture" {{ old('categorie') == 'culture' ? 'selected' : '' }}>Culture
                                    </option>
                                    <option value="sante" {{ old('categorie') == 'sante' ? 'selected' : '' }}>Santé
                                    </option>
                                    <option value="actualite" {{ old('categorie') == 'actualite' ? 'selected' : '' }}>
                                        Actualité</option>
                                </select>
                            </div>
                            <div class="field">
                        ...
                        <div class="form-row">
                            <div class="field">
                                ...
                                <input type="text" id="auteur" name="auteur"
                                    value="{{ old('auteur') ?? auth()->user()->nom . ' ' . auth()->user()->prenom }}">
                            </div>
                            <div class="field">
                        ...
                        <div class="form-row full">
                            <div class="field">
                                ...
                                <textarea id="resume" name="resume" maxlength="300" required
                                    ...
                                    oninput="document.getElementById('m-rc').textContent=this.value.length+'/300'">{{ old('resume') }}</textarea>
                                <div style="display:flex;justify-content:flex-end;">
                                    <span class="char-count" id="m-rc">{{ strlen(old('resume')) }}/300</span>
                                </div>
                            </div>
                        </div>
                        <div class="form-row full">
                            <div class="field">
                                ...
                                <textarea id="contenu" name="contenu" style="min-height:130px;" required
                                    placeholder="Rédigez le contenu complet de l'actualité…">{{ old('contenu') }}</textarea>
