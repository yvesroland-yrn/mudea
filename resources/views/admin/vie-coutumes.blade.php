    ...
    <tr data-record='@json($item)'>
      ...
      <td>
        <div class="action-btns">
          <a href="#" class="btn-icon btn-icon--view"  title="Voir" onclick="openVieCoutumesRecordModal('view', this); return false;">    <i class="fas fa-eye"></i>   </a>
          <a href="#" class="btn-icon btn-icon--edit"  title="Modifier" onclick="openVieCoutumesRecordModal('edit', this); return false;"><i class="fas fa-pen"></i>   </a>
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <input id="f-titre" type="text" name="titre" class="form-control"
                 placeholder="Ex : Article sur la fête annuelle…" required>
        </div>
        ...
        <div class="form-group">
          ...
          <textarea id="f-description" name="description" class="form-control"
                    placeholder="Résumé ou description du contenu…" required></textarea>
        </div>
