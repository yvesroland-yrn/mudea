...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"></script>
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .sidebar-logo-text strong { display: block; font-size: .95rem; font-weight: 900; color: var(--green-dark); line-height: 1.1; }
    .sidebar-logo-text span { font-size: .68rem; color: var(--text-light); line-height: 1.3; }
    ...
    .nav-item.active {
      background: var(--green-mid); color: white; font-weight: 800;
    ...
    .nav-separator { height: 1px; background: rgba(255,255,255,.08); margin: 10px 20px; }

    .sidebar-bottom { padding: 12px 0 16px; border-top: 1px solid rgba(255,255,255,.08); flex-shrink: 0; }
    .nav-item--logout { color: #ef9a9a; }
    .nav-item--logout:hover { background: rgba(229,57,53,.12); color: #ef5350; }
    ...
    .topbar-menu-btn {
      ...
      color: var(--text-mid); font-size: 1.1rem; transition: background .2s;
    }
    .topbar-menu-btn:hover { background: var(--cream); }
    .topbar-page-title strong { font-size: 1.2rem; font-weight: 800; color: var(--text); display: block; line-height: 1.1; }
    .topbar-page-title span { font-size: .78rem; color: var(--text-light); }
    .topbar-right { display: flex; align-items: center; gap: 16px; }
    .topbar-notif {
      position: relative; width: 40px; height: 40px;
      border-radius: 50%; background: var(--cream); border: 1px solid var(--border);
      display: flex; align-items: center; justify-content: center;
      cursor: pointer; color: var(--text-mid); font-size: 1rem; transition: background .2s;
    }
    .topbar-notif:hover { background: var(--green-light); }
    .topbar-notif-badge {
      position: absolute; top: -2px; right: -2px;
      background: #e53935; color: white; font-size: .6rem; font-weight: 900;
    ...
    .topbar-avatar img { width: 100%; height: 100%; object-fit: cover; object-position: top; display: block; }
    .topbar-avatar-placeholder { width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; color: var(--green); font-size: 1rem; }
    .topbar-user-info strong { display: block; font-size: .88rem; font-weight: 800; color: var(--text); line-height: 1.1; }
    .topbar-user-info span { font-size: .72rem; color: var(--text-light); }
    .topbar-chevron { color: var(--text-light); font-size: .75rem; }
